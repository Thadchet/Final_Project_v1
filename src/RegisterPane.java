...
public class RegisterPane extends BorderPane {
	...
	public RegisterPane() {
		...
		//gamename.setStyle("-fx-font-size: 32px; -fx-font-family:\"Arial Black\";-fx-fill: #555;");
		
		Label name = new Label("Name");
		TextField nametext = new TextField();
		nametext.setPromptText("Enter your name");
		enterBtn = new Button("Enter");
		enterBtn.setStyle("-fx-text-fill: white; -fx-font-weight: bold; -fx-font-family: \"Arial Narrow\"; -fx-background-color: darkgreen;");
		
		how = new Button("How to play");
		quit = new Button("Quit");
		how.setStyle("-fx-text-fill: white; -fx-font-weight: bold; -fx-font-family: \"Arial Narrow\"; -fx-background-color: darkgreen;");
		quit.setStyle("-fx-text-fill: white; -fx-font-weight: bold; -fx-font-family: \"Arial Narrow\"; -fx-background-color: darkred;");
